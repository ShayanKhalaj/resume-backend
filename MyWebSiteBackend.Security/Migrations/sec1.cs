...
namespace MyWebSiteBackend.Security.Migrations
{
    public partial class sec1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    ...
                    PictureUrl=table.Column<string>("nvarchar(max)", nullable: true),
                    MobileNumber=table.Column<string>("nvarchar(max)", nullable: true),
                    IsMobileConfirmed=table.Column<bool>("bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                table => new
                {
                    Id=table.Column<int>("int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FKUserID=table.Column<int>("int", nullable: false),
                    FKRoleID=table.Column<int>("int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserRole", x => x.Id);
                    table.ForeignKey(
                        "FK_ApplicationUserRole_AspNetRoles_FKRoleID",
                        x => x.FKRoleID,
                        "AspNetRoles",
                        "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        "FK_ApplicationUserRole_AspNetUsers_FKUserID",
                        x => x.FKUserID,
                        "AspNetUsers",
                        "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                "IX_ApplicationUserRole_FKRoleID",
                "ApplicationUserRole",
                "FKRoleID");

            migrationBuilder.CreateIndex(
                "IX_ApplicationUserRole_FKUserID",
                "ApplicationUserRole",
                "FKUserID");
